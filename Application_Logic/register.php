...
$name_err = $surname_err = $email_err = $role_err = "" ;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($role_err) && empty($email_err) && empty($surname_err) && empty($name_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssss", $name , $surname , $param_username, $param_password ,  $param_email, $param_role );
